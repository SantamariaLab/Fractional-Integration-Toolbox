...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Windows 7 with Visual Studio 2010 C++ Professional (Build Script)
% Reference: http://msdn.microsoft.com/en-us/library/fwkeyyhe(v=vs.80).aspx
% Using maximum optimization /Ox
% Windows 7 with Visual Studio 2010 C++ Professional ( cl compiler )
% Note: Professional version required to use multi-threading.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
mex -v frint.cpp -output frint_hermite_double COMPFLAGS="$COMPFLAGS /openmp /DMATLABINTERFACE /DHERMITE /DOPENMP /DDOUBLEPRECISION" OPTIMFLAGS="/Ox /Oy- /DNDEBUG"
mex -v frint.cpp -output frint_cubic_double COMPFLAGS="$COMPFLAGS /openmp /DMATLABINTERFACE /DCUBIC /DOPENMP /DDOUBLEPRECISION" OPTIMFLAGS="/Ox /Oy- /DNDEBUG"
mex -v frint.cpp -output interpolate_hermite_double COMPFLAGS="$COMPFLAGS /openmp /DMATLABINTERFACE /DHERMITE /DOPENMP /DDOUBLEPRECISION /DINTERPOLATEONLY" OPTIMFLAGS="/Ox /Oy- /DNDEBUG"
mex -v frint.cpp -output interpolate_cubic_double COMPFLAGS="$COMPFLAGS /openmp /DMATLABINTERFACE /DCUBIC /DOPENMP /DDOUBLEPRECISION /DINTERPOLATEONLY" OPTIMFLAGS="/Ox /Oy- /DNDEBUG"
