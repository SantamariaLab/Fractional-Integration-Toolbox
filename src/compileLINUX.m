...
mex -v frint.cpp -output frint_hermite_double CC="g++" CXXFLAGS="\$CXXFLAGS -O3 -fopenmp -DMATLABINTERFACE -DHERMITE -DOPENMP -DDOUBLEPRECISION -DFIRSTORDER -DNDEBUG" LDFLAGS="\$LDFLAGS -fopenmp" CXXDEBUGFLAGS="" CXXOPTIMFLAGS="-O3 -DNDEBUG"

% HERMITE Interpolation Only: Double Precision
mex -v frint.cpp -output interpolate_hermite_double CC="g++" CXXFLAGS="\$CXXFLAGS -O3 -fopenmp -DMATLABINTERFACE -DINTERPOLATEONLY -DHERMITE -DOPENMP -DDOUBLEPRECISION -DNDEBUG" LDFLAGS="\$LDFLAGS -fopenmp" CXXDEBUGFLAGS="" CXXOPTIMFLAGS="-O3 -DNDEBUG"

% CUBIC ( With First Correction( First Order ) ): Double Precision
mex -v frint.cpp -output frint_cubic_double CC="g++" CXXFLAGS="\$CXXFLAGS -O3 -fopenmp -DMATLABINTERFACE -DCUBIC -DOPENMP -DDOUBLEPRECISION -DFIRSTORDER -DNDEBUG" LDFLAGS="\$LDFLAGS -fopenmp" CXXDEBUGFLAGS="" CXXOPTIMFLAGS="-O3 -DNDEBUG"

% CUBIC Interpolation Only: Double Precision
mex -v frint.cpp -output interpolate_cubic_double CC="g++" CXXFLAGS="\$CXXFLAGS -O3 -fopenmp -DMATLABINTERFACE -DINTERPOLATEONLY -DCUBIC -DOPENMP -DDOUBLEPRECISION -DNDEBUG" LDFLAGS="\$LDFLAGS -fopenmp" CXXDEBUGFLAGS="" CXXOPTIMFLAGS="-O3 -DNDEBUG"
