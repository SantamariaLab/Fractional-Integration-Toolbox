...
%  END OF LICENSE
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [cout]=fracDerivative(dt,DataMatrix,alpha,NumericalAlgorithm) 
...
switch NumericalAlgorithm
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
     if (  gpuDeviceCount == 0 )
         ...
         nn=1:NN-1;
         WCoeGPU=gpuArray((NN-nn).^mu-(NN-nn-1).^mu);
         TeDiGPU=gpuArray(DataMatrix(2:end,:)-DataMatrix(1:end-1,:));
         J00=WCoeGPU*TeDiGPU;
         
         cout=gather(MultC*(WCoe0*DataMatrixGPU(1,:)+J00));
     end
     %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
   otherwise
